...
{
  [SupportedOSPlatform("windows")] public static readonly DotnetFramework V20       = new("v2.0       ".Trim());
  [SupportedOSPlatform("windows")] public static readonly DotnetFramework V30       = new("v3.0       ".Trim());
  [SupportedOSPlatform("windows")] public static readonly DotnetFramework V35       = new("v3.5       ".Trim());
  [SupportedOSPlatform("windows")] public static readonly DotnetFramework V40Client = new("v4.0 Client".Trim());
  [SupportedOSPlatform("windows")] public static readonly DotnetFramework V40Full   = new("v4.0 Full  ".Trim());
  [SupportedOSPlatform("windows")] public static readonly DotnetFramework V4xClient = new("v4.x Client".Trim());
  [SupportedOSPlatform("windows")] public static readonly DotnetFramework V4xFull   = new("v4.x Full  ".Trim());
  /************************************************/
